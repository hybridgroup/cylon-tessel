...
//        this.name = opts.name || this.constructor.randomName();
      ...
      Robot.prototype.initConnections = function(connections) {
        ...
        for (i = 0, len = c.length; i < len; i++) {
          ...
          c[connection.name] = new Cylon.Connection(connection);
        }
        this.connections = c;
      ...
      Robot.prototype.initDevices = function(devices) {
        ...
        for (i = 0, len = d.length; i < len; i++) {
          ...
          device['robot'] = this;
//          results.push(d[device.name] = new Cylon.Device(device));
          results.push(this.devices[device.name] = new Cylon.Device(device));
        }
        return results;
      };
      */
      ...
      Robot.prototype.start = function() {
        ...
        return this.startConnections(function() {
          return this1.robot.startDevices(function() {
            return this1.robot.work.call(this1.robot, this1.robot);
          });
        });
      };

      Robot.prototype.startConnections = function(callback) {
        var connection, n, starters, ref;
