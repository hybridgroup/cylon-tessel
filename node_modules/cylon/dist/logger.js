...
(function() {
  ...
  BasicLogger = (function() {
    ...
    BasicLogger.prototype.debug = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return console.log.apply(console, ["D, [" + (new Date().toString()) + "] DEBUG -- :"].concat(__slice.call(args)));
    };

    BasicLogger.prototype.info = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return console.log.apply(console, ["I, [" + (new Date().toString()) + "]  INFO -- :"].concat(__slice.call(args)));
    };

    BasicLogger.prototype.warn = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return console.log.apply(console, ["W, [" + (new Date().toString()) + "]  WARN -- :"].concat(__slice.call(args)));
    };

    BasicLogger.prototype.error = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return console.log.apply(console, ["E, [" + (new Date().toString()) + "] ERROR -- :"].concat(__slice.call(args)));
    };

    BasicLogger.prototype.fatal = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return console.log.apply(console, ["F, [" + (new Date().toString()) + "] FATAL -- :"].concat(__slice.call(args)));
    };
